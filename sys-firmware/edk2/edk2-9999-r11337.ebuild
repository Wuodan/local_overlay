...
SLOT="0"
KEYWORDS="~amd64"
IUSE="hardened hello-world qemu shell"
...
#     inlined from âSVfrVarStorageNode::SVfrVarStorageNode(EFI_GUID*, CHAR8*, EFI_VARSTORE_ID, EFI_STRING_ID, UINT32, BOOLEAN)â at VfrUtilityLib.cpp:1309:41:
...
# In function âvoid* memset(void*, int, size_t)â,
#     inlined from âSVfrVarStorageNode::SVfrVarStorageNode(EFI_GUID*, CHAR8*, EFI_VARSTORE_ID, SVfrDataType*, BOOLEAN)â at VfrUtilityLib.cpp:1336:41:
# /usr/include/bits/string3.h:85:70: warning: call to void* __builtin___memset_chk(void*, int, long unsigned int, long unsigned int) will always overflow destination buffer
